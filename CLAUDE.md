...
2. **`studio/`** — a Python + Remotion production engine. Two entry points:
...
- `studio/config/brand.json` — shared visual style (colors, fonts, caption positioning). Used by both `originate.py` and `pipeline.py`.
