...
REV_D_SCREEN: dict[str, dict] = {
    ...
    "thesis-02": dict(layout="broll", role="human_context", camera="human",
                      ...
                      queries=["small independent hotel owner working front desk guests keys", "boutique hotel innkeeper helps guests reception", "bed and breakfast owner greeting guests front desk"]),
    "evidence-03": dict(layout="broll", role="human_context", camera="human",
                        ...
                        queries=["boutique hotel owner guest experience front desk Mexico", "Mexico boutique hotel staff welcoming guest", "small tropical hotel reception owner guest"]),
    "evidence-04": dict(layout="broll", role="human_context", camera="human",
                        ...
                        queries=["bed and breakfast owner working alone front desk phone", "small hotel receptionist multitasking phone guest", "innkeeper alone reception phone computer"]),
    ...
    "playbook-01": dict(layout="broll", role="process", camera="human",
                        ...
                        queries=["hotel owner reviewing booking website guest journey laptop notes", "innkeeper laptop notebook booking website audit", "hotel manager reviewing website reservations laptop"]),
    "playbook-03": dict(layout="broll", role="human_context", camera="human",
                        ...
                        queries=["small hotel owner multitasking reception housekeeping phone", "innkeeper cleaning room answering phone", "bed and breakfast owner working reception alone"]),
    ...
    "playbook-06": dict(layout="broll", role="outcome", camera="human", state="agency", score="counter",
                        ...
                        queries=["returning hotel guest greeted by owner room key independent hotel", "boutique hotel owner welcomes couple room key", "innkeeper greeting repeat guests at reception"]),
    "economics-03": dict(layout="broll", role="outcome", camera="human", state="agency", score="human",
                         ...
                         queries=["hospitality consultant reviewing hotel performance with owner laptop", "hotel manager consultant looking at laptop dashboard", "small hotel owner advisor reviewing reservations"]),
    "cta-01": dict(layout="broll", role="outcome", camera="human", state="agency", score="resolve",
                   ...
                   queries=["independent hotel owner welcoming returning guests room key", "boutique innkeeper greeting guests key handoff", "small hotel owner welcomes couple reception"]),
}
