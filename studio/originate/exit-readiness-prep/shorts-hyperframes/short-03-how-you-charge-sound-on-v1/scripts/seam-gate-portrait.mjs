#!/usr/bin/env node
// seam-gate-portrait.mjs — portrait-canvas adaptation of the canonical
// motion-doctrine Seam Gate. The canonical utility hard-codes a 1920x1080
// viewport and therefore marks valid y>1080 portrait carriers as off-screen.
...
const HARNESS = `window.__seamGate = {
  ...
  read(sel){
    ...
    const onscreen = r.right > 0 && r.bottom > 0 && r.left < 1080 && r.top < 1920;
