# Blueprint Cinema director packet: sequence-playbook-04
...
Sequence: `sequence-playbook-04`
Previous sequence: `sequence-playbook-03`
Next sequence: `sequence-playbook-05`
Time range: `619.332-655.774` seconds
Locked word range: `1326-1396`
Exact VO: `Once that path works, you can widen the discovery work. Keep the profile current. Show the actual hotel instead of posting generic travel content. Ask happy guests for specific reviews. Build referral partnerships that fit the stay. Everything should point to the hotel's own booking page. And every automated message should have a person who reads it. The blueprint below turns this into an audit and installation checklist you can use.`
...
|---:|---:|---:|---|
| 1326 | 619.980 | 620.044 | Once |
| 1327 | 620.076 | 620.204 | that |
| 1328 | 620.284 | 620.604 | path |
| 1329 | 620.711 | 621.644 | works, |
| 1330 | 621.684 | 621.804 | you |
| 1331 | 621.844 | 621.964 | can |
| 1332 | 622.044 | 622.444 | widen |
| 1333 | 622.464 | 622.524 | the |
| 1334 | 622.580 | 623.084 | discovery |
| 1335 | 623.164 | 623.564 | work. |
| 1336 | 623.756 | 624.524 | Keep |
| 1337 | 624.544 | 624.604 | the |
| 1338 | 624.674 | 625.164 | profile |
| 1339 | 625.234 | 625.804 | current. |
| 1340 | 625.964 | 626.604 | Show |
| 1341 | 626.624 | 626.684 | the |
| 1342 | 626.775 | 627.324 | actual |
| 1343 | 627.431 | 627.964 | hotel |
| 1344 | 628.034 | 628.524 | instead |
| 1345 | 628.551 | 628.604 | of |
| 1346 | 628.664 | 629.084 | posting |
| 1347 | 629.154 | 629.644 | generic |
| 1348 | 629.690 | 629.964 | travel |
| 1349 | 630.044 | 630.684 | content. |
| 1350 | 631.004 | 631.964 | Ask |
| 1351 | 632.031 | 632.364 | happy |
| 1352 | 632.421 | 632.764 | guests |
| 1353 | 632.824 | 633.004 | for |
| 1354 | 633.084 | 633.724 | specific |
| 1355 | 633.804 | 634.444 | reviews. |
| 1356 | 634.644 | 635.644 | Build |
| 1357 | 635.697 | 636.124 | referral |
| 1358 | 636.186 | 636.924 | partnerships |
| 1359 | 636.988 | 637.244 | that |
| 1360 | 637.304 | 637.484 | fit |
| 1361 | 637.544 | 637.724 | the |
| 1362 | 637.804 | 638.444 | stay. |
| 1363 | 638.560 | 639.724 | Everything |
| 1364 | 639.758 | 639.964 | should |
| 1365 | 640.031 | 640.364 | point |
| 1366 | 640.391 | 640.444 | to |
| 1367 | 640.484 | 640.604 | the |
| 1368 | 640.697 | 641.404 | hotel's |
| 1369 | 641.484 | 641.724 | own |
| 1370 | 641.774 | 642.124 | booking |
| 1371 | 642.220 | 643.004 | page. |
| 1372 | 643.124 | 643.484 | And |
| 1373 | 643.577 | 644.044 | every |
| 1374 | 644.100 | 644.604 | automated |
| 1375 | 644.674 | 645.164 | message |
| 1376 | 645.233 | 645.644 | should |
| 1377 | 645.692 | 645.884 | have |
| 1378 | 645.924 | 645.964 | a |
| 1379 | 646.044 | 646.524 | person |
| 1380 | 646.604 | 646.844 | who |
| 1381 | 646.897 | 647.164 | reads |
| 1382 | 647.244 | 647.644 | it. |
| 1383 | 648.349 | 648.364 | The |
| 1384 | 648.420 | 648.924 | blueprint |
| 1385 | 649.004 | 649.404 | below |
| 1386 | 649.497 | 649.964 | turns |
| 1387 | 650.044 | 650.364 | this |
| 1388 | 650.444 | 650.764 | into |
| 1389 | 650.844 | 651.004 | an |
| 1390 | 651.071 | 651.404 | audit |
| 1391 | 651.544 | 651.964 | and |
| 1392 | 652.032 | 652.844 | installation |
| 1393 | 652.916 | 653.564 | checklist |
| 1394 | 653.684 | 654.044 | you |
| 1395 | 654.084 | 654.204 | can |
| 1396 | 654.344 | 655.164 | use. |
...
[
  {
    "action": "Widen discovery work only after the direct destination and return controls operate.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "in": 619.332,
    "mode": "system",
    "motion_verb": "discover",
    "narration_anchor": {
      "quote": "Once that path works, you can widen the discovery work. Keep the profile current.",
      "word_end": 1339,
      "word_start": 1326
    },
    "narrative_state": "installation",
    "out": 625.884,
    "sequence_id": "sequence-playbook-04",
    "status": "greybox",
    "world_state_after": [
      {
        "object_id": "market-discovery",
        "state": "active"
      }
    ],
    "world_state_before": [
  ...
  {
    "action": "Show the actual property and guest experience instead of generic travel material.",
    "asset_ticket_ids": [
      "ticket-inn-reality"
    ],
    "audio_state": {
    ...
    "motion_verb": "welcome",
    "narration_anchor": {
      "quote": "Show the actual hotel instead of posting generic travel content. Ask happy guests for",
      "word_end": 1353,
      "word_start": 1340
    },
    "narrative_state": "installation",
  ...
  {
    "action": "Keep review requests, referrals, and automated messages visibly resolved through a responsible person.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "motion_verb": "review",
    "narration_anchor": {
      "quote": "specific reviews. Build referral partnerships that fit the stay. Everything should point to the hotel's",
      "word_end": 1368,
      "word_start": 1354
    },
    "narrative_state": "installation",
  ...
  {
    "action": "Resolve qualified attention toward the already repaired direct booking destination.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "motion_verb": "route",
    "narration_anchor": {
      "quote": "own booking page. And every automated message should have a person who reads it.",
      "word_end": 1382,
      "word_start": 1369
    },
    "narrative_state": "installation",
  ...
  {
    "action": "Pull back to the installed audit-and-operation checklist as accumulated system state.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "motion_verb": "resolve",
    "narration_anchor": {
      "quote": "The blueprint below turns this into an audit and installation checklist you can use.",
      "word_end": 1396,
      "word_start": 1383
    },
    "narrative_state": "installation",
