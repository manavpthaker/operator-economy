# Blueprint Cinema director packet: sequence-evidence-04
...
Sequence: `sequence-evidence-04`
Previous sequence: `sequence-evidence-03`
Next sequence: `sequence-evidence-05`
Time range: `218.704-252.662` seconds
Locked word range: `466-532`
Exact VO: `costing. Here's a simple way to see it. Take a twenty-room hotel, a $180 average daily rate, and 70 percent occupancy. If more than 60 percent of its reservations come through OTAs and the commission lands in the low twenties, my estimate is roughly $135,000 a year. Your hotel may look completely different. That's fine. Run the real numbers. Put a dollar figure next to the problem.`
...
|---:|---:|---:|---|
| 466 | 218.744 | 219.384 | costing. |
| 467 | 220.712 | 220.824 | Here's |
| 468 | 220.864 | 220.904 | a |
| 469 | 220.950 | 221.224 | simple |
| 470 | 221.264 | 221.384 | way |
| 471 | 221.437 | 221.544 | to |
| 472 | 221.584 | 221.704 | see |
| 473 | 221.784 | 222.024 | it. |
| 474 | 222.168 | 222.744 | Take |
| 475 | 222.784 | 222.824 | a |
| 476 | 222.881 | 223.464 | twenty-room |
| 477 | 223.544 | 224.584 | hotel, |
| 478 | 224.664 | 224.744 | a |
| 479 | 225.044 | 225.944 | $180 |
| 480 | 226.004 | 226.424 | average |
| 481 | 226.477 | 226.744 | daily |
| 482 | 226.840 | 227.304 | rate, |
| 483 | 227.444 | 227.864 | and |
| 484 | 228.104 | 228.584 | 70 |
| 485 | 228.634 | 228.984 | percent |
| 486 | 229.072 | 229.944 | occupancy. |
| 487 | 230.291 | 230.984 | If |
| 488 | 231.032 | 231.224 | more |
| 489 | 231.272 | 231.464 | than |
| 490 | 231.704 | 232.104 | 60 |
| 491 | 232.174 | 232.664 | percent |
| 492 | 232.691 | 232.744 | of |
| 493 | 232.784 | 232.904 | its |
| 494 | 232.966 | 233.704 | reservations |
| 495 | 233.768 | 234.024 | come |
| 496 | 234.054 | 234.264 | through |
| 497 | 234.397 | 235.144 | OTAs |
| 498 | 235.284 | 235.704 | and |
| 499 | 235.724 | 235.784 | the |
| 500 | 235.835 | 236.344 | commission |
| 501 | 236.424 | 236.824 | lands |
| 502 | 236.877 | 236.984 | in |
| 503 | 237.004 | 237.064 | the |
| 504 | 237.144 | 237.384 | low |
| 505 | 237.464 | 238.744 | twenties, |
| 506 | 238.824 | 238.984 | my |
| 507 | 239.055 | 239.624 | estimate |
| 508 | 239.677 | 239.784 | is |
| 509 | 239.854 | 240.344 | roughly |
| 510 | 240.504 | 242.504 | $135,000 |
| 511 | 242.544 | 242.584 | a |
| 512 | 242.648 | 242.984 | year. |
| 513 | 243.224 | 244.184 | Your |
| 514 | 244.251 | 244.584 | hotel |
| 515 | 244.664 | 244.904 | may |
| 516 | 244.936 | 245.064 | look |
| 517 | 245.108 | 245.544 | completely |
| 518 | 245.592 | 246.104 | different. |
| 519 | 246.200 | 246.664 | That's |
| 520 | 246.744 | 247.224 | fine. |
| 521 | 247.384 | 247.864 | Run |
| 522 | 247.904 | 248.024 | the |
| 523 | 248.104 | 248.424 | real |
| 524 | 248.494 | 249.144 | numbers. |
| 525 | 249.910 | 250.030 | Put |
| 526 | 250.110 | 250.190 | a |
| 527 | 250.247 | 250.590 | dollar |
| 528 | 250.647 | 250.990 | figure |
| 529 | 251.070 | 251.390 | next |
| 530 | 251.417 | 251.470 | to |
| 531 | 251.490 | 251.550 | the |
| 532 | 251.620 | 252.190 | problem. |
...
[
  {
    "action": "Establish the illustrative hotel model as assumptions rather than a reported property result.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "narration_anchor": {
      "quote": "costing. Here's a simple way to see it. Take a twenty-room hotel, a",
      "word_end": 478,
      "word_start": 466
    },
    "narrative_state": "proof",
    "out": 224.894,
    "sequence_id": "sequence-evidence-04",
    "status": "greybox",
    "world_state_after": [
      {
        "object_id": "proof-zone",
        "state": "active"
      }
    ],
    "world_state_before": [
  ...
  {
    "action": "Run rooms and occupancy through the first-booking money flow as a visible model.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "motion_verb": "measure",
    "narration_anchor": {
      "quote": "$180 average daily rate, and 70 percent occupancy. If more than 60 percent of",
      "word_end": 492,
      "word_start": 479
    },
    "narrative_state": "proof",
  ...
  {
    "action": "Apply average rate and OTA share while retaining every assumption beside the model.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "motion_verb": "compare",
    "narration_anchor": {
      "quote": "its reservations come through OTAs and the commission lands in the low twenties,",
      "word_end": 505,
      "word_start": 493
    },
    "narrative_state": "proof",
    ...
    "world_state_after": [
      {
        "object_id": "ota-settlement-ledger",
        "state": "active"
      }
    ],
    "world_state_before": [
  ...
  {
    "action": "Apply the low-twenties commission range and expose the illustrative annual consequence.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "motion_verb": "measure",
    "narration_anchor": {
      "quote": "my estimate is roughly $135,000 a year. Your hotel may look completely different. That's",
      "word_end": 519,
      "word_start": 506
    },
    "narrative_state": "proof",
  ...
  {
    "action": "Return the model to a blank operator field that demands the property's real numbers.",
    "asset_ticket_ids": [],
    "audio_state": {
      "music": false,
      "narration": true,
    ...
    "motion_verb": "audit",
    "narration_anchor": {
      "quote": "fine. Run the real numbers. Put a dollar figure next to the problem.",
      "word_end": 532,
      "word_start": 520
    },
    "narrative_state": "proof",
  ...
  "objects": [
    {
      "id": "proof-zone",
      "kind": "zone",
      "label": "Operator proof bench",
      "description": "Sources, model parameters, settlement consequence, and measurement remain attached to the system.",
      "zone_id": "proof-zone",
      "position": {
        "x": 1670,
        "y": 110
...
[
  {
    "id": "evidence-commission-model",
    "label": "Illustrative commission model and assumptions",
    "target_ids": [
      "first-booking-money-flow",
      "ota-settlement-ledger"
    ],
    "claim_ids": [
      "claim-illustrative-commission-cost"
    ],
    "parameter_ids": [
      "parameter-room-count",
      "parameter-adr",
      "parameter-occupancy",
      "parameter-commission-range"
    ],
    "source_path": "studio/originate/direct-booking-recovery/script.json",
    "source_sha256": "15b2f1b3cc1e66488135cd876c6f019bcbb3a08ac425866bffc570de0c3bccf6",
