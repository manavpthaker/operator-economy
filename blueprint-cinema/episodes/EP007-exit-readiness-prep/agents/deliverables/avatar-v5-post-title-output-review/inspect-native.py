...
WORK = REPO / 'blueprint-cinema/episodes/EP007-exit-readiness-prep/agents/work-orders/avatar-v5-post-title-output-review.json'
...
probes = {}
for label, path in [('accepted_v5',baseline),('post_title_native',native)]:
...
contacts = [
    ...
    sheet(native,[0,1,2,3,4,5,6,7,8],'post-title-early-middle'),
    sheet(native,[9,10,10.5,11,11.5,12,12.5,13,13.5,14,14.5,15],'post-title-late-ending'),
    sheet(native,[0,2,4,6,8,9,10,11,11.5,12,13,14,15],'post-title-hand-detail',(.20,.43,.82,1)),
]
