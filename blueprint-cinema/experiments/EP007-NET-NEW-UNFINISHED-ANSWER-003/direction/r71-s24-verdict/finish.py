...
H=EXP/'hyperframes/reviews/r71-s24-verdict';C=EXP/'hyperframes/reviews/r71-s24-context'
...
cmd=['ffmpeg','-y','-v','error','-i',str(EXP/'hyperframes/reviews/r70-s23-payoff/qa/s23.mp4'),'-i',str(H/'qa/s24.mp4'),'-i',str(MASTER),
 '-filter_complex','[0:v]trim=start_frame=38:end_frame=230,setpts=PTS-STARTPTS[v0];[1:v]trim=start_frame=0:end_frame=552,setpts=PTS-STARTPTS[v1];[v0][v1]concat=n=2:v=1:a=0[v];[2:a]atrim=start_sample=51384000:end_sample=52872000,asetpts=PTS-STARTPTS,pan=stereo|c0=c0|c1=c0[a]',
...
with wave.open(str(MASTER),'rb') as src:src.setpos(25884*2000);expected=src.readframes(552*2000)
...
report={'status':'technical_pass_owner_review_pending','pcm_bit_exact':True,'strict_check':True,'runtime':'0.8.46','source_sha256':sha(H/'index.html'),
 'scene':inspect(H/'qa/s24.mp4',25884/24,552),'context':inspect(C/'qa/context.mp4',25692/24,744),
...
frames=[0,96,191,192,237,243,355,361,450,456,549,550,556,660,720,743]
