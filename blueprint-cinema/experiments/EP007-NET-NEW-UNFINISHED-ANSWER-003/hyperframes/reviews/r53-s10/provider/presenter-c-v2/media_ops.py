"""R53 part C v2 authorized single-attempt restoration; no paid retries."""
...
if mode=='upload-audio':
    ...
    with (out/'SUBMISSION-INTENT.json').open('x') as f:
        json.dump({'at':datetime.datetime.now(datetime.timezone.utc).isoformat(),'model':'fal-ai/sync-lipsync/v3','payload':payload,'estimated_usd':cost,'cap_usd':CAP_USD,'owner_statement':'yes submit it (C v2)','no_retry':True},f,indent=2)
