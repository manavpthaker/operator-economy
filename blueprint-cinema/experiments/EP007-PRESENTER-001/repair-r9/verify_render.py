"""Verify Test I geometry, complete decode, and exact preservation of G's audio."""
import hashlib
import json
import subprocess
...
OUTPUT = ROOT / 'media/repair-r9/test-i-landscape-study-refined-1080p.mp4'
...
foreground = json.loads((ROOT / 'repair-r9/foreground-qa.json').read_text())
...
report = {
    ...
    'composition_sha256': sha(ROOT / 'study-composite-r9/index.html'),
    'motion_asset_sha256': sha(ROOT / 'study-composite-r9/assets/shirt-motion.js'),
...
(ROOT / 'repair-r9/technical-review.json').write_text(json.dumps(report, indent=2) + '\n')
