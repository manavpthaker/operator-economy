...
RATE = 16000
MAX_OFFSET = 1.0
WINDOWS = [('opening', 0.2, 10.5), ('section_2', 20.3, 35.4), ('section_3', 36.3, 47.2), ('final_question', 47.9, 52.5)]
...
def main():
    ...
    result = {
        ...
        'original_final_word_output_estimate_seconds': [52.30 + lag / RATE, 52.50 + lag / RATE],
