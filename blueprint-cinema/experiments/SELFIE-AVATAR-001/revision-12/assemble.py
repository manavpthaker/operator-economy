#!/usr/bin/env python3
"""Append a silent 84-frame closing plate; run only in the Higgsfield sandbox.
...
BODY_FRAMES, CLOSE_FRAMES, FPS = 1322, 84, 24
...
def main():
    ...
    try:
        ...
        work = Path(tempfile.mkdtemp(prefix="r12-append-", dir=output.parent))
        ...
        require(abs(report["final_format_duration_seconds"] - 1406 / FPS) < 0.002,
