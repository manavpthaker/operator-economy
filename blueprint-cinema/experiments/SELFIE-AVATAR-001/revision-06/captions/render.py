"""R6 burn preserving the latest requested highlighted Counterproof heading captions.

The narrator and relative word clock remain the R4 source. The caller supplies
fresh waveform alignment evidence and an SRT rebased to the measured R6 Sync
...
# R6 decoded waveform with the unchanged full R4 narration. It must bind this
