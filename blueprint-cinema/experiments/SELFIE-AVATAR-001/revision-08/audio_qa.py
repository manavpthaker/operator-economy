...
RATE = 16000
MAX_OFFSET = 1.0
GLOBAL_WINDOWS = [('first_line',.2,3.4),('smile_and_WithAI',3.8,6.25),('following_sentence',6.4,10.6),('engine_through_code',11.3,16.7),('then_researches',17.1,20.8)]
...
def main():
    ...
    if section is None:
        ...
        content_end = 21.237895833333333
    else:
    ...
    result = {
        ...
        'original_final_word_output_estimate_seconds': ([20.3063578175707 + lag / RATE, 20.771767761937877 + lag / RATE] if section is None else ([52.30 - 862 / 24 + lag / RATE, 52.50 - 862 / 24 + lag / RATE] if section == 3 else None)),
