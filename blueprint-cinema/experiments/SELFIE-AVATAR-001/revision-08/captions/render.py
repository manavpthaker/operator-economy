"""R8 expression-only review with the latest requested Counterproof heading captions.

Preserve the R7 edited voice, its actual sample map, and all 18 cues/68 words.
Apply only the freshly measured offset to the new clean R8 expression sample.
The installed burner preserves the existing heading design and soundtrack.
"""
import base64
import hashlib
import io
