"""R9 quieter-articulation review with the current Counterproof heading captions.

Preserve the R7 voice, its actual sample map, and all 18 cues/68 words.
Use the freshly measured alignment of the unchanged voice to the finished
review video. The burner preserves heading design, timing, and soundtrack.
"""
import base64
import hashlib
import io
...
# Additional review-only face crops show articulation and small head movements.
...
report = {'status':'mechanically_verified_pending_visual_review',
          ...
          'timing_method':'actual piecewise voice sample map plus measured final audio insertion offset',
