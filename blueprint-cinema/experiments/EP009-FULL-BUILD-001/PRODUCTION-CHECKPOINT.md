...
Avatar opening: `direction/r4-owner-opening-lock/OWNER-LOCK.json`. Active exact selection: `presenter-regen/ACTIVE-OPENING.json`. Preserve P00 picture `[0,86)`, the unchanged narration and the cut to F01 source frame86. This accepted take must not be regenerated or retimed for optional polish. Prior candidate/index/QA records retain their historical pre-acceptance state; this owner lock is the current decision. Other presenter replacements and release remain separate.

Owner: “the brand pause and corrected experience are good - lock those.” Exact scoped acceptance and protected hashes: `direction/r3-owner-revisions/OWNER-LOCK.json`. Shortened brand pause and corrected spoken wording/timing are frozen. Other presenter pictures, new film and release are separate.
...
## Opening complete; remaining presenter work
...
Fal is available. Existing P01a and P01b both restored successfully, but both remain flagged for perceptual lip-sync review. Bound pilot report: `presenter-regen/diagnostics/pilot-restored-r1/PILOT-REVIEW.json`; SHA256 `5b6cbdd7d20e531ce38a3f9a5f04a4b20d585e8c2fdec6c8d11d6a5dfdf0b5ef`. No bulk clearance or P01 integration. Do not repeat completed restoration jobs or ask for funding again.

P00 is generated, restored and now owner-accepted under the exact opening lock above. The exact first sentence occupies picture frames `[0,86)` (3.583333 seconds); F01 `[86,135)` and F02 at frame135 are retained. Private 10.5-second context: `presenter-regen/P00/qa/opening-context-private-r1.mp4`, SHA256 `76dc0f8c458b6127e120d74eb65c3a26adb7dec6bf0170be0b1a90a2f3f8bf97`. Native timing selection preserves the original wrong-phrase measurement and independently anchored correction; unchanged drift limit passes at 0.18 seconds. Restored audio identity/trim passes. Pre-acceptance diagnostic history, retained unchanged: zero qualifying onset samples is insufficient measurement; weak mouth correlation favors the guide, 0.382 versus narration 0.343. Dense-frame inspection did not establish a sustained gross mismatch; possible anticipation is unresolved.

The prior root decision permitted a separate, explicitly flagged **review candidate** of P00. The subsequent owner lock now accepts its exact delivery and cut; automated metrics remain unchanged. Exact decision: `direction/r3-owner-revisions/P00-CANDIDATE-DECISION.json`, decision event `ep009-p00-flagged-review-candidate`. Only picture `[0,86)` may differ from r3. Full candidate rendered: `assembly/qa/r4/ep009-full-r4-opening-candidate.mp4`, SHA256 `c60d5d111cbea3346203a15b842d521f09070c975627c0dd7f500c9f412fcbee`, 29,323 frames / 20:22. Short context: `assembly/qa/r4/ep009-r4-opening-context-candidate.mp4`, SHA256 `8c88fc8eef66767f2ed75dc453242d14a7c1dfc3594d2d73a6f9baa317ae7df1`, 252 frames / 10.5 seconds. Both candidate VERIFICATION records pass full decode, unchanged source mapping outside [0,86), and audio checks while preserving all unresolved sync flags. `assembly/r4/CANDIDATE-SCOPE-AUDIT.md` documents the independent scope and budget audit. Existing `build_r4.py` readiness rules, pending `final-r5/INDEX.json`, active plan and all flags remain unchanged.

Offline `presenter-regen/EXECUTION-PLAN-r5.json` and `_tools/regen_r5.py` are prepared and independently audited. All 22 guidance WAVs match their exact r3 master slices. Corrected P08r3a/b are prepared and uploaded with verified remote hashes; old P08a/b/c remain invalid. Global `ACTIVE-PLAN.json` remains r4 with its revision hold. The 19 remaining generations stay inactive pending bound pilot clearance. Do not submit retired `BATCH-REQUESTS-r3.json` or infer clearance from a candidate render.
...
- Separate presenter regeneration: 223.5 Higgsfield credits spent, including P00 32.5; 1,800 cap unchanged. Remaining planned generation is 1,526 credits, giving a projected 1,749.5 total and 50.5 contingency. P00 live balance reconciled 1,617.5 to 1,585. No new bulk calls.
- Fal restoration: P01a $0.5668, P01b $0.8444, P00 $0.5111; total $1.9223 of $30, $28.0777 remaining. Amounts use quoted $8/min and submitted durations; invoice not independently fetched.
