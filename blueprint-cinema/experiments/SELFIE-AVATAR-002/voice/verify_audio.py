...
path=Path('/home/user/w2-'+cfg['stage']+'-qa.wav');path.write_bytes(data)
...
Path('/home/user/w2-'+cfg['stage']+'-qa-report.json').write_bytes(report_bytes)
