...
The owner subsequently approved the exact two-provider seven-second test. Existing HeyGen CLI authentication bills the Creator subscription, not the separate API cash balance. Read-only live account showed 557 credits before submission and 553 afterward; record the observed four-credit decrease rather than the earlier approximately two-credit estimate. No new cash purchase or credential change occurred. The seven-second HeyGen result is complete and locally verified; per-video billing detail remains unavailable, so the four-credit figure is explicitly an observed account debit. Moving-face acceptance is pending. WaveSpeed InfiniteTalk then completed the identical seven-second sample for an observed $0.42 debit. HeyGen now has owner concerns about lips and perceived voice; InfiniteTalk owner review is pending. Provider receipts are in test-03/.
