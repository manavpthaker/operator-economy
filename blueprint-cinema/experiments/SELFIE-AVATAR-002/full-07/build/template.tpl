...
<html lang="en">
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      #hook-plate { z-index:2; clip-path:inset(150px 0 0 0); }
      #hook-title { position:absolute; left:40px; top:204px; width:660px; margin:0; z-index:3; font-family:Archivo, sans-serif;
        font-size:116px; line-height:112px; font-weight:780; letter-spacing:-.05em; color:var(--graphite); }
      #hook-title span { display:block; }
      #hook-matte { z-index:4; -webkit-mask-image:linear-gradient(to bottom, transparent 0, transparent 48px, #000 70px); mask-image:linear-gradient(to bottom, transparent 0, transparent 48px, #000 70px); }
  ...
  <body>
    <div id="root" data-composition-id="week2-full07" data-start="0" data-width="720" data-height="1280" data-duration="{{DURATION}}">
      ...
      <div id="hook-ground" class="clip" data-start="0" data-duration="{{HOOK_END}}" data-track-index="1"></div>
