#!/usr/bin/env python3
"""Append a silent 168-frame HyperFrames closing plate using local FFmpeg.

Usage: python assemble.py accepted-full04.mp4 closing.mp4 full.mp4 ASSEMBLY-QA.json
...
ACCEPTED_SHA = "7019cafe97ebe69d4904bc18c2059565e7ecaa71d58e9a829590439f926a5377"
BODY_FRAMES, CLOSE_FRAMES, FPS = 933, 168, 24
...
def main():
    ...
    try:
        ...
        report["accepted_full04_sha256"] = sha(source)
        require(report["accepted_full04_sha256"] == ACCEPTED_SHA, "Accepted full-04 SHA mismatch")
        ...
        work = Path(tempfile.mkdtemp(prefix="full05-append-", dir=output.parent))
