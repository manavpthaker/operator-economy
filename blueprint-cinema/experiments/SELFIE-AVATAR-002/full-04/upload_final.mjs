...
const source=path.join(base,'assembly/renders/week2-full04-uncaptioned.mp4');
...
try{
 const file_url=await fal.storage.upload(new File([bytes],'selfie-week2-full04-'+sha256.slice(0,16)+'.mp4',{type:'video/mp4'}));
