...
> animatics, and render plates; DaVinci Resolve is canonical for final editorial,
> conform, Fusion, color, Fairlight, captions, online, and delivery. The isolated Remotion
> renderer is a preserved v1 prototype, not an authorized new-production path. Read
> `blueprint-cinema/TOOLCHAIN.md` before post-VO visual work.
>
