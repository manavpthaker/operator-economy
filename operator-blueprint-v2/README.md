...
Status: Step 0.2 is canonical. Step 1 v1.5 is approved editorial authority. Step 2 is proposed v0.1. Stages 3-8 remain boundary-only and non-authoritative.
...
| `02-narration-production/` | Perform the locked words, produce final narration, transcript, and narration lock | **Proposed v0.1; ready for calibration tests; not authority** |
