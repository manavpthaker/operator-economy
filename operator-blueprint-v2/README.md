...
| `02-narration-production/` | Perform the locked words, produce final narration, transcript, pause map, and narration lock | **Proposed v0.2; ready for calibration tests; not authority** |
