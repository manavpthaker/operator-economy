...
Engine SHA-256: [hash] · World SHA-256: [hash] · Visual plan SHA-256: [hash]

## Visual thesis

One sentence a builder can direct from. Not a description of the topic.

## Emotional progression

| Stage | Where in the episode | What the viewer should feel | How the visuals produce it |
|---|---|---|---|
| Opening tension | | | |
| Curiosity | | | |
| Recognition | | | |
...
Each mode gets its own direction. They must be distinguishable on sight.

| Mode | Environment | Camera height and lens | Light | Texture | Movement | Labelling | Permissible reconstruction |
|---|---|---|---|---|---|---|---|
| Reality | | | | | | | |
| System | | | | | | | |
| Proof | | | | | | | |
...
Roles permitted, sourcing standard, and what footage may never be asked to prove.
...
The specific things this episode will not do.

- 

## Gate V5a decision

- Visual thesis is directable in one sentence: yes / no
- Emotional progression mapped: yes / no
