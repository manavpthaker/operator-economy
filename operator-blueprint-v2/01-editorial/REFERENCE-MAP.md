...
External live sources remain authoritative at their original locations. Approved local Step 1 sources remain authoritative inside this stage. Every episode lock must record the versions or hashes actually reviewed.
...
## Frozen V1 reference identities

The following identities refer to the committed contents at Operator Economy commit `a96d4ec`. They are not copied into V2 because each mixes useful ideas with superseded structure or later-stage concerns.

| V1 artifact | SHA-256 at `a96d4ec` | Useful Step 1 concept | Do not inherit |
|---|---|---|---|
| `docs/content-rubric.md` | `960ca011cf983c932d28dba7887b6b1b70b9f70fe48f06928988b495b142107e` | Honest promise, useful hook, spoken trust, no income promises | Title, thumbnail, visual cadence, edit, Shorts, and publishing rules |
| `docs/vo-first-production-flow.md` | `e8dd7d045c9416ec6dc99e113947b4172b6922feb8e217e80c147385c1221af8` | Explicit script lock, hash invalidation, final narration before visuals | V1 state names, coverage system, and mixed narration/production ownership |
| `studio/config/blueprint.json` | `1a1d691561a2aac703fa3532aed48cae3c36b4f68abcda227292762c98e326f8` | Problem, evidence, stack, playbook, economics completeness | Fixed seven-section order, runtime quotas, tool defaults, render and packaging configuration |
| `studio/scripts/originate/script_readthrough.py` | `1409ca608a589f4b6581071842d3df9d5dfc6c238ca4bba4da9eda4205d1e0c1` | Metadata-free performance read-through | V1 section assumptions and executable implementation |
| `studio/scripts/originate/eval_script.py` | `b0bf09fb3ebf4f7201e9d7bd8b9dbab8d5340cbcad60ba25226e0654d3563a05` | Deterministic checks for promises, claims, placeholders, and duration warnings | Numeric scoring as approval, mandatory section order, evidence-span shortcuts, packaging checks |
| `research/craft-rubric/README.md` | `f30a2ffb725dcd80f796b7a61fd5cef3606d617864e7f0bdc1477bb34d758c23` | Honest opening, promise delivery, authenticity, post-release calibration | Unverified benchmarks as canon, visual/package rules inside editorial, faceless-format assumptions |

## Step 2 references deliberately excluded

Voice ID, provider configuration, generation scripts, audio cleanup, mastering, transcript tooling, and non-lexical performance-tag contracts are not Step 1 references. They belong to Narration Production. The observed speech profile is included here only because its lexical choices must already exist in the locked script.

## Rule

Reference material may inspire a rule, but it does not become V2 authority through mention or copying. A V2 rule must appear in an approved V2 standard and survive the V2 acceptance set.
